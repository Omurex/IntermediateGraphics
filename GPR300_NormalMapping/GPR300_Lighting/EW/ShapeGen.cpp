...
namespace ew {
	void createPlane(float width, float height, MeshData& meshData) {
		...
		Vertex vertices[4] = {
			//Front face
			{glm::vec3(-halfWidth, 0, -halfHeight), glm::vec3(0,1,0), glm::vec2(1, 1), glm::vec3(1, 0, 0)}, //BL
			{glm::vec3(+halfWidth, 0, -halfHeight), glm::vec3(0,1,0), glm::vec2(0, 1), glm::vec3(1, 0, 0)}, //BR
			{glm::vec3(+halfWidth, 0, +halfHeight), glm::vec3(0,1,0), glm::vec2(0, 0), glm::vec3(1, 0, 0)}, //TR
			{glm::vec3(-halfWidth, 0, +halfHeight), glm::vec3(0,1,0), glm::vec2(1, 0), glm::vec3(1, 0, 0)} //TL
		};
	...
	void createQuad(float width, float height, MeshData& meshData) {
		...
		Vertex vertices[4] = {
			//Front face
			{glm::vec3(-halfWidth, -halfHeight, 0), glm::vec3(0,0,1), glm::vec2(1, 1), glm::vec3(1, 0, 0)}, //BL
			{glm::vec3(+halfWidth, -halfHeight, 0), glm::vec3(0,0,1), glm::vec2(0, 1), glm::vec3(1, 0, 0)}, //BR
			{glm::vec3(+halfWidth, +halfHeight, 0), glm::vec3(0,0,1), glm::vec2(0, 0), glm::vec3(1, 0, 0)}, //TR
			{glm::vec3(-halfWidth, +halfHeight, 0), glm::vec3(0,0,1), glm::vec2(1, 0), glm::vec3(1, 0, 0)} //TL
		};
		meshData.vertices.assign(&vertices[0], &vertices[4]);
		unsigned int indices[6] = {
			// front face
	...
	void createCube(float width, float height, float depth, MeshData& meshData)
	{
		...
		Vertex vertices[24] = {
			//Front face
			{glm::vec3(-halfWidth, -halfHeight, +halfDepth), glm::vec3(0,0,1), glm::vec2(0, 1), glm::vec3(1, 0, 0)}, //BL
			{glm::vec3(+halfWidth, -halfHeight, +halfDepth), glm::vec3(0,0,1), glm::vec2(1, 1), glm::vec3(1, 0, 0)}, //BR
			{glm::vec3(+halfWidth, +halfHeight, +halfDepth), glm::vec3(0,0,1), glm::vec2(1, 0), glm::vec3(1, 0, 0)}, //TR
			{glm::vec3(-halfWidth, +halfHeight, +halfDepth), glm::vec3(0,0,1), glm::vec2(0, 0), glm::vec3(1, 0, 0)}, //TL
			...
			{glm::vec3(+halfWidth, -halfHeight, -halfDepth), glm::vec3(1,0,0), glm::vec2(1, 1), glm::vec3(0, 0, 1)}, //BR
			{glm::vec3(+halfWidth, +halfHeight, -halfDepth), glm::vec3(1,0,0), glm::vec2(1, 0), glm::vec3(0, 0, 1)}, //TR
			{glm::vec3(+halfWidth, +halfHeight, +halfDepth), glm::vec3(1,0,0), glm::vec2(0, 0), glm::vec3(0, 0, 1)}, //TL
